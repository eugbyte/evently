		...
		protected override void Up(MigrationBuilder migrationBuilder) {
			...
			migrationBuilder.InsertData(
				...
				columns: new[] {
					...
					"LockoutEnd", "Name", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber",
					"PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName"
				},
				values: new object[,] {
					{
						"empty-user-12345", 0, "EMPTY-CONCURRENCY-STAMP-12345", "empty@example.com", false, true, null,
						"Empty User", "EMPTY@EXAMPLE.COM", "EMPTY_USER", null, null, false,
						"EMPTY-SECURITY-STAMP-12345", false, "empty_user"
					}, {
						"guest-user-22222", 0, "EMPTY-CONCURRENCY-STAMP-12345", "guest@example.com", false, true, null,
						"Guest User", "GUEST@EXAMPLE.COM", "GUEST_USER_2", null, null, false,
						"EMPTY-SECURITY-STAMP-12345", false, "guest_user2"
					}
				});
			...
			migrationBuilder.InsertData(
				table: "Bookings",
				columns: new[] {
					"BookingId", "AttendeeId", "CancellationDateTime", "CheckInDateTime", "CheckoutDateTime",
					"CreationDateTime", "GatheringId"
				},
				values: new object[,] {
					{
						"book_abc123456", "guest-user-22222", null, null, null,
						new DateTimeOffset(new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
							new TimeSpan(0, 0, 0, 0, 0)),
						1L
					}, {
						"book_def789012", "empty-user-12345", null, null, null,
						new DateTimeOffset(new DateTime(2024, 1, 1, 1, 0, 0, 0, DateTimeKind.Unspecified),
							new TimeSpan(0, 0, 0, 0, 0)),
						2L
					}
				});
